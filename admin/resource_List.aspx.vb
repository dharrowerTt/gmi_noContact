    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            For x = 0 To dt.Rows.Count - 1
                ...
                "</td><td><a href='/events/details.aspx?eventid=" & dt.Rows(x)("eventid") & "' >" & dt.Rows(x)("eventName") & "</a>" &
                 "</td><td>" & dt.Rows(x)("eventid") &
                "</td><td>" & dt.Rows(x)("resourceLanguage") &
                "</td><td>" & dt.Rows(x)("status") & "</td><td><a href='/resources/details.aspx?resourceid=" & ResourceId & "' >Preview</a></td></tr>"
