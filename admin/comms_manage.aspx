<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="comms_manage.aspx.vb" Inherits="M2M_Redesign.comms_manage" %>
...
<html>
<head runat="server">
    <title>Admin | Edit Communications</title>
              ...
              <div class="form-group">
                  ...
                  <asp:TextBox ID="subjectLine" class="form-control" placeholder="Subject Line" runat="server" required></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="dateSent" class="form-control" type="text" runat="server"></asp:TextBox>

                    </div>
                    <asp:Button ID="Edit" runat="server" Text="Edit" class="btn btn-primary btn-lg" />
                    <asp:Button ID="Delete" runat="server" Text="Delete" class="btn btn-primary btn-lg" />
                ...
                <h6>Date Sent</h6>
                    Select the date that the message was distributed. Format should be in yyyy/mm/dd (2021/02/28 for example).
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
