...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents resourcePages As System.Web.UI.WebControls.TextBox
    Protected WithEvents libPartnerCountries As System.Web.UI.WebControls.ListBox
    Protected WithEvents libSectors As System.Web.UI.WebControls.ListBox
    Protected WithEvents libDocumentType As System.Web.UI.WebControls.ListBox
    Protected WithEvents libFileType As System.Web.UI.WebControls.ListBox
    Protected WithEvents libLanguage As System.Web.UI.WebControls.ListBox
    Protected WithEvents libEvents As System.Web.UI.WebControls.ListBox

    Protected WithEvents resourceFiledate As System.Web.UI.WebControls.TextBox


    Protected WithEvents txtresourceTopic As Global.FreeTextBoxControls.FreeTextBox
    ...
    Protected WithEvents resourceLink_response As System.Web.UI.WebControls.Label
    Protected WithEvents resourceLink As System.Web.UI.WebControls.FileUpload
    Protected WithEvents txtresourceLink As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtresourceParentName As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtresourceSize As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtfileType As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents btnCancel2 As System.Web.UI.WebControls.Button
    Protected WithEvents btnDelete2 As System.Web.UI.WebControls.Button
    Protected WithEvents btnUpload As System.Web.UI.WebControls.Button
    Protected WithEvents phresourceLink As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents resourceFileFrame As System.Web.UI.HtmlControls.HtmlGenericControl
    Protected WithEvents resourceFileLink As System.Web.UI.WebControls.HyperLink
    Protected WithEvents pnlEvents As System.Web.UI.WebControls.Panel
    Protected WithEvents pnlSector As System.Web.UI.WebControls.Panel
    Protected WithEvents pnlCountry As System.Web.UI.WebControls.Panel
    Protected WithEvents RQname As System.Web.UI.WebControls.RequiredFieldValidator
    Protected WithEvents RQresourcePages As System.Web.UI.WebControls.RequiredFieldValidator

    Protected WithEvents RQsector As System.Web.UI.WebControls.RequiredFieldValidator

    'Protected WithEvents RQresourceFiledate As System.Web.UI.WebControls.RequiredFieldValidator

    Protected WithEvents RQtxtresourceTopic As System.Web.UI.WebControls.RequiredFieldValidator
...
#Region "CallBack Functions"
    ...
    Protected Sub UploadFile(sender As Object, e As EventArgs) Handles btnUpload.Click
        ...
        Dim imgFolderPath As String = Server.MapPath("../assets/images/")
        ...
        If ResourceType.SelectedValue = "urlInclude" Then
            txtresourceLink.Text = urlPath.Text
            resourceFiledate.Text = ""
            txtresourceSize.Text = ""
        Else
                        ...
                        If System.IO.File.Exists(curFile) = True Then
                            ...
                            If resourceImage.HasFile Then   '2
                                ...
                                If fileok = True Then
                                    ...
                                    Try
                                        Dim curImgFile As String = Server.MapPath("../assets/images/" & resourceImage.FileName)

                                        If System.IO.File.Exists(curImgFile) = True Then
                                            msgText += "An image with this name already exists.<br>"
                                            'plnResourceUpload.Visible = False
                                            txtResourceImage.Text = "../assets/images/" & resourceImage.FileName  '3
        ...
        If resourceImage.HasFile Then   '2
            ...
            If fileok = True Then
                ...
                Dim fileUrl As String = ""
                Try
                    Dim curFile As String = Server.MapPath("../assets/images/" & resourceImage.FileName)
                ...
                txtResourceImage.Text = "../assets/images/" & resourceImage.FileName  '4
    ...
    Protected Sub SaveNewResource(ByVal s As Object, ByVal e As CommandEventArgs)
        ...
        Next
        If NoCountry = 0 Then
            clsResourceDAO.insertResourceCountry(newresourceID, 85, "N/A")
        End If
...
#End Region
    ...
    Protected Sub HideNotes1_Click(sender As Object, e As EventArgs) Handles HideNotes1.Click

        pnlAuthorInfo.Visible = False
        pnlNameInfo.Visible = False
        pnlParentNameInfo.Visible = False
        pnlParentResource.Visible = False
        pnlResourceDetails.Visible = False
        pnlShortNameInfo.Visible = False
        ...
        infoDocType.Visible = False
        infotopic.Visible = False
        Show1.Visible = True
        HideNotes1.Visible = False


    End Sub

    Protected Sub Show1_Click(sender As Object, e As EventArgs) Handles Show1.Click

        pnlAuthorInfo.Visible = True
        pnlNameInfo.Visible = True
        pnlParentNameInfo.Visible = True
        pnlParentResource.Visible = True
        pnlResourceDetails.Visible = True
        pnlShortNameInfo.Visible = True
        ...
        infoDocType.Visible = True
        pnlEvents.Visible = True
        infotopic.Visible = True
        Show1.Visible = False
        HideNotes1.Visible = True
    End Sub
End Class
