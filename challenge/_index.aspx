		...
		<div id="wrapper">
			<nav>
				<ul>
					...
					<li id="storynav">
						<a href="#story">Tell Your Story</a>
					</li>
			...
			<section class="panel banner right" id="home" style="overflow: hidden;">
				<div class="content color1 span-4-25">
					...
					<p style="color:black;">Tell us how you’re reducing methane emissions! Join the Global Methane
						Challenge and showcase your work in methane mitigation. 						<a href="#story" style="font-weight:bold;">Tell your story</a>.</p>
					
					<p style="color:black;"><a class="lightlink" href="#info"><i style="float:right; bottom:0;"
								class="fa fa-2x fa-arrow-circle-right" aria-hidden="true"></i></a>
						The Global Methane Challenge is open to all public- and private-sector actors interested in
						showcasing their actions to address methane emissions. The goal of the Challenge is to catalyze
						ambitious action around the world to reduce methane emissions and highlight policies and
						technologies being used to recover and use methane. Learn
						more about the
...
-->
				...
				<div class="inner columns aligned">
					<div class="span-2-5">
						...
						<h2 class="major">
							...
							Challenge&nbsp;<a class="lightlink" href="#GMCvideo"><i class="fa  fa-arrow-circle-right"
					...
					<div class="span-3-25">
						...
						<ul class="idealist">
							<li style="">
								...
								<p>Monitor methane emissions and create&nbsp;emissions&nbsp;inventories.</p>
							</li>
							<li style="">
								<img class="item" src="images/listicons/001-wedding-planning.svg">
								<p>Develop action plans for reducing emissions in one or more<br>sectors.</p>
							</li>
							<li>
						...
						<p>For additional ideas for specific sectors, click <a href="documents/GMC_Ideas.pdf"
							...
							Fact Sheet <a href="pdf/GMC Fact Sheet.pdf">in English <i class="fa fa-download"
			...
			<section class="panel" id="GMCvideo" style="background:rgba(0,0,0,0.8);">
				<div class="inner columns aligned">

					<div class="span-3">
							<h2 class="major">
								<a class="lightlink" href="#info"><i class="fa  fa-arrow-circle-left" aria-hidden="true"></i></a>&nbsp;The Challenge Video&nbsp;<a class="lightlink" href="#gmf"><i class="fa  fa-arrow-circle-right" aria-hidden="true"></i></a></h2>
								<iframe width="560" height="315" src="https://www.youtube.com/embed/O9WNkUeiMTw?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							</div>
					
				</div>
			</section>
			<section class="panel color8" id="gmf">
				<div class="inner columns aligned">

					<div class="span-4">
						<h2 class="major">
							<a class="lightlink" href="#GMCvideo"><i class="fa  fa-arrow-circle-left" aria-hidden="true"></i></a>&nbsp;GMF 2020&nbsp;<a class="lightlink"
								href="#actionmap"><i class="fa  fa-arrow-circle-right" aria-hidden="true"></i></a></h2>
						<a style="text-decoration:none;border-bottom:0;" href="../gmf2020/"><img
								src="../images/gmfUpdate.png" style="width:100%; text-decoration:none;"></a><br>
						All Challenge participants are recognized for their leadership on methane mitigation and
						featured on this website, in emails and via social media. Participants will also be acknowledged
						at the prestigious Global Methane Forum.<br><br>
						Learn more about the <a class="lightlink" href="../gmf2020">Global Methane Forum 2020</a>.
					</div>
			...
			<section class="panel color6" id="actionmap">
				<div class="intro">
					<h2 class="major">
						<a class="lightlink" href="#gmf"><i class="fa  fa-arrow-circle-left"
			...
			<section class="panel color3" id="actions">
				<div class="intro span-4">
					<div class="">
						...
						<p style="width:500px;">Click on the photos to learn more about the methane mitigation
							activities taking place in different industry sectors around the world.</p>
						<p style="width:500px;""><a href=" list.html" class="lightlink">View a list of all GMC
							actions</a>.</p>
					</div>
				</div>
				<div class="gallery">
					...
					<div class="span-3">
						<div class="oilgascontent">
							...
							<ul>
								...
								<ul>
									<li><a href="aie.html">Asset Integrity Engineering</a></li>
									<li><a href="https://www.globalmethane.org/challenge/bluesource.html">Bluesource</a>
									</li>
									<li><a href="https://www.globalmethane.org/challenge/ecopetrol.html">Ecopetrol</a>
									</li>
									<li><a href="https://globalmethane.org/challenge/gc.html">GC Green Carbon Inc.</a></li>
									<li><a href="https://globalmethane.org/challenge/ghgsat.html">GHGSat, Inc.</a></li>
									<li><a href="ingevity.html">Ingevity Corporation</a></li>
									<li><a href="https://www.globalmethane.org/challenge/lidar.html">LiDAR Services
											International</a></li>
									<li><a href="process.html">Process Ecology Inc.</a></li>
									<li><a href="src.html">Saskatchewan Research Council (SRC)</a></li>
									<li><a href="sirius.html">Sirius Instrumentation & Controls </a></li>
									<li><a href="sniffers.html">Sniffers</a></li>
									<li><a href="westgen.html">Westgen</a></li>
								</ul>
							</ul>
						</div>
						<div class="biogascontent">
							...
							<ul>
								...
								<li><a href="https://www.globalmethane.org/challenge/kazakhstan.html">Kazakhstan</a>
								</li>
								<li><a href="https://www.globalmethane.org/challenge/naucalpan.html">Nucalpan de
										Juárez</a></li>
							...
							<ul>
								<li><a href="arctic.html">Arctic Council's Expert Group on Black Carbon and Methane</a></li>
								<li><a href="https://www.globalmethane.org/challenge/baleen.html">Baleen International,
										Inc.</a></li>
								<li><a href="https://www.globalmethane.org/challenge/biocover.html">Biocover A/S </a>
								</li>
								<li><a href="https://www.globalmethane.org/challenge/ews.html">Engineered Waste Systems
										(EWS) LLC</a></li>
								<li><a href="fao.html">FAO and GRA:  Measuring and Reducing Enteric Methane from Livestock</a></li>
								<li><a href="https://globalmethane.org/challenge/iitd.html">Indian Institute of Technology</a></li>										
								<li><a href="https://www.globalmethane.org/challenge/punjab.html">Punjab Agricultural
										Management & Extension Training Institute</a></li>
								<li><a href="https://www.globalmethane.org/challenge/sourcefacilitybiocity.html">Source
										Facility and BioCity</a></li>
								<li><a href="https://globalmethane.org/challenge/abiogas.html">Abiogas</a></li>
								<li><a href="https://globalmethane.org/challenge/iav.html">Hassan II Institute of Agronomy and Veterinary Sciences</a></li>
								<li><a href="https://globalmethane.org/challenge/mootral.html">Mootral</a></li>
								<li><a href="https://globalmethane.org/challenge/solucycle.html">Solucycle</a></li>
							</ul>
							</ul>
						</div>
						<div class="coalcontent">
							...
							<ul>
								...
								<ul>
									<li><a href="francaise.html">La Française de l’Energie</a></li>
										<li><a href="https://www.globalmethane.org/challenge/hydraulic.html">Hydraulic Fracturing of Kuznetsk LLC  </a></li>
									<li><a href="https://www.globalmethane.org/challenge/mnec.html">MNEC</a></li>
								</ul>
							</ul>
							</ul>
						</div>
				...
				<div class="intro">
					<h2 class="major">
						<a class="lightlink" href="#actions"><i class="fa  fa-arrow-circle-left"
								aria-hidden="true"></i></a>&nbsp;FAQs&nbsp;<a class="lightlink" href="#story"><i
								class="fa  fa-arrow-circle-right" aria-hidden="true"></i></a></h2>
					<p></p>
				</div>
				<div class="inner columns">
					<div class="span-6">
						...
						<div class="tab">
							<button class="tablinks" onclick="openCity(event, 'who')" id="defaultOpen">Who can
								participate?</button>
							<button class="tablinks" onclick="openCity(event, 'what')">What type of information should I
								submit?</button>
						...
						<p>The Global Methane Challenge was launched to help all public and private actors showcase their specific actions to reduce methane throughout the year. In order to share your success story, please send us a case study or a description of the particular action or commitment you are taking, technical information about how you measure success of your efforts, as well as graphics, illustrations, or photographs that help bring your action to life. Please note that featuring GMC projects does not imply endorsement by the Global Methane Initiative (GMI).</p> 
						  ...
						  <table>
								<tr height="100px"
									style="background-color:rgba(0,0,0,0);border-top:0px;border-bottom:0px;">
									<td>
										<ul class="contact-icons color1">
											<a target="_blank" href="https://twitter.com/globalmethane">
												<li class="icon fa-twitter" title="GMI's Twitter Account"
						...
						<div id="other" class="tabcontent">
							...
							<p>Feel free to email any GMI- or GMC-related questions to <a
									href="mailto:secretariat@globalmethane.org">secretariat@globalmethane.org</a>.</p>
						</div>
			...
			<section class="panel" id="story">
				<div class="intro" style="background:rgba(0,0,0,0.8);">
					<h2 class="major">
						<a class="lightlink" href="#faq"><i class="fa  fa-arrow-circle-left" aria-hidden="true"></i></a>&nbsp;Tell
						your story</h2>
						<p>Get featured on the Challenge website by reaching out with your story.
					<h4> <a href="submitvideo.html">Enhance your story with a video</a>!</h4>
				</div>
					...
					<div class="span-4">
						<form runat="server">
							<div class="fields">
								...
								<div class="field half">
									Provide your contact information and press submit to launch an online form to
									provide more details about your story. Download the form <a href="docx/gmc form_EN.docx" download>in English</a> | <a href="docx/gmc form_ES.docx" download>en Español</a> | <a href="docx/gmc form_FR.docx">En Français</a>
								</div>
								<div class="field half">
		...
		AmCharts.makeChart("map", {
			...
			"dataProvider": {
				...
				"images": [{
...

					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Baleen International, Inc.',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Bluesource Methane:<br>Bluesource Methane Reduction Program',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Engineered Waste Systems (EWS) LLC:<br>Waste Management ',
						//Poland			
					},
					{
					"selectable": true,
					"longitude": -105.698830,
						"latitude": 53.427944,
						"svgPath": "M3.5,13.277C3.5,6.22,9.22,0.5,16.276,0.5C23.333,0.5,29.053,6.22,29.053,13.277C29.053,14.54,28.867,15.759,28.526,16.914C26.707,24.271,16.219,32.5,16.219,32.5C16.219,32.5,4.37,23.209,3.673,15.542C3.673,15.542,3.704,15.536,3.704,15.536C3.572,14.804,3.5,14.049,3.5,13.277C3.5,13.277,3.5,13.277,3.5,13.277M16.102,16.123C18.989,16.123,21.329,13.782,21.329,10.895C21.329,8.008,18.989,5.668,16.102,5.668C13.216,5.668,10.876,8.008,10.876,10.895C10.876,13.782,13.216,16.123,16.102,16.123C16.102,16.123,16.102,16.123,16.102,16.123",
						"color": "rgba(72,168,138,1)",
						"scale": 1,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Sirius Instrumentation & Controls',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Hydraulic Fracturing of Kuznetsk LLC ',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'MNEC:<br>Developing a Coal Mine Methane Emissions Inventory ',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'BioCover A/S - Acidification of Agricultural Slurry C:<br>Developing a Coal Mine Methane Emissions Inventory ',
						//Poland			
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Arctic Council\'s Expert Group on Black Carbon and Methane ',
						//Poland			
					},
					...
					},
					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'La Française de l’Energie',
						//Poland			
					},
					{
						"selectable": true,
					...
					},
					{
						...
						"color": "rgba(72,168,138,1)",
						"scale": 1,
						"url": 'sourcefacilitybiocity.html',
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
					...
					},
					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Punjab Agricultural Management & Extension Training Institute:<br>Advocating No-Burn Agriculture to Reduce Emissions',
						//India
					},
					{
						"selectable": true,
						"longitude": -118.698830,
						"latitude": 60.427944,
						"svgPath": "M3.5,13.277C3.5,6.22,9.22,0.5,16.276,0.5C23.333,0.5,29.053,6.22,29.053,13.277C29.053,14.54,28.867,15.759,28.526,16.914C26.707,24.271,16.219,32.5,16.219,32.5C16.219,32.5,4.37,23.209,3.673,15.542C3.673,15.542,3.704,15.536,3.704,15.536C3.572,14.804,3.5,14.049,3.5,13.277C3.5,13.277,3.5,13.277,3.5,13.277M16.102,16.123C18.989,16.123,21.329,13.782,21.329,10.895C21.329,8.008,18.989,5.668,16.102,5.668C13.216,5.668,10.876,8.008,10.876,10.895C10.876,13.782,13.216,16.123,16.102,16.123C16.102,16.123,16.102,16.123,16.102,16.123",
						"color": "rgba(72,168,138,1)",
						"scale": 1,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Saskatchewan Research Council:<br>Centre for the Demonstration of Emissions Reductions',
						//India
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Process Ecology Inc.,:<br>Process Optimization at Glycol Dehydration Facilities ',
						//India
					},
					{
						"selectable": true,
					...
					},
					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Hassan II Institute of Agronomy and Veterinary Sciences ',
						//India
					},
					{
						"selectable": true,
					...
					},
					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'HAUG Sauer Kompressoren AG ',
						//India
					},
					{
						"selectable": true,
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'FAO and GRA:  Measuring and Reducing Enteric Methane from Livestock  ',
						//India
					},
					{
						"selectable": true,
					...
					//////////////////////////////////////////
					{
						...
						"balloonText": '[[title]]',
						"cancelButtonColor": '#4c5c96',
						"title": 'Ingevity Corporation:<br>Adsorbed Natural Gas for Flare Gas Recovery and Utilization',
						//India
					},
			...
			"legend": {
				...
				"data": [{
					...
					"title": "International/Subnational",
					"color": "#48A88A"
				}]
			}
		});
