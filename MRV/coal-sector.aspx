<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="coal-sector.aspx.vb" Inherits="M2M_Redesign.coal_sector" %>

<html xmlns="http://www.w3.org/1999/xhtml">

<head runat="server">
    <title>Measurement, Reporting and Verification (MRV) of Methane: Coal Mines Sector  | Global Methane Initiative</title>
...
<body>
    ...
    <section class="py-5 gmi-light-blue">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h1>Measurement, Reporting and Verification (MRV) of Methane: Coal Mines Sector </h1>
                    <p>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <p>This page is currently under development.  Check back soon for tools to support the MRV of methane emissions and emissions reductions in the Coal Mines Sector.</p>
