<%@ Page Language="VB" AutoEventWireup="false" Inherits="M2M_Redesign.msw" Codebehind="msw.aspx.vb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Municipal Solid Waste Technical Group | Global Methane Initiative</title>
     <!-- #include virtual="/includes/include_head.html" -->
</head>
<body>
    <!-- #include virtual="/includes/header.html" -->
    <form id="msw_form" runat="server">
    <div>
    <!-- Page Content -->
	<!-- Page Content -->
	<section class="py-5 gmi-light-blue">
        <div class="container">
			<div class="row py-2">
				<div class="col-sm-8">
                    <h1>Municipal Solid Waste Technical Group</h1>
					<p>There are opportunities to reduce CH<sub>4</sub> emissions by collecting the CH<sub>4</sub> containing landfill gas and using it to fuel boilers, engines, or other technologies. CH<sub>4</sub> emissions from municipal solid waste (MSW) can also be reduced by modifying how the waste is treated. For example, organic fractions of the MSW stream can be diverted from landfills and instead disposed of at anaerobic digesters, composting facilities, or waste-to-energy facilities. Using these climate friendly MSW solutions can yield energy, economic, environmental, and public health benefits.</p>
				</div>
                <div class="col-sm-4">
					<img src="../images/bkgd_sector_land_banner2.jpg" style="width:100%;" />
					<p class="small">MSW management and treatment activities are sources of methane (CH<sub>4</sub>) emissions worldwide.</p>
				</div>
			</div>
	...
	<section class="py-5 bg-white">
		<div class="container" id="technicalgroup">
					...
					<div class="row py-2">
                        <div class="col-sm-4">
							<h2>Co-chairs</h2>
                              <p><strong>Matt Hamilton</strong><br>
                              Environment and Climate Change Canada (ECCC)<br>
                              Canada</p>
						</div>
                        <div class="col-sm-4">
                              <h2>Members</h2>
                              <p>Representatives from 32 countries participate in the group.</p>
							  <p><a href="../delegates/index.aspx?sector=MSW" role="button" class="btn btn-outline-primary">View Delegates</a></p>
                  ...
                  <p><a href="index.aspx#tools" role="button" class="btn btn-outline-primary">Featured Biogas Resources</a></p>
                                ...
                                <p>Visit the GMI resource library to find tools, reports, presentations, and more related to mitigating methane emissions in the municipal solid waste sector.</p>
                              <p><a href="../resources/index.aspx?sector=Municipal Solid Waste" role="button" class="btn btn-outline-primary">View MSW Resources</a></p>
                            </div>
                    </div>
	...
	<section class="py-5">
		<div class="container">
			...
			<div class="row">
              <div class="col-sm-4">
				<p><strong>Are you interested in collaborating with GMI's Municipal Solid Waste Technical Group on methane mitigation projects?</strong></p>
