<%@ Page Language="VB" AutoEventWireup="false" Inherits="M2M_Redesign.agriculture" Codebehind="agriculture.aspx.vb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Agriculture Technical Group  | Global Methane Initiative</title>
     <!-- #include virtual="/includes/include_head.html" -->
</head>
<body>
    <!-- #include virtual="/includes/header.html" -->
    <form id="ag_form" runat="server">
    <div>
    <!-- Page Content -->
 <!-- Page Content -->
	<section class="py-5 gmi-light-blue">
        <div class="container">
			<div class="row py-2">
				<div class="col-sm-8">
                    <h1>Agriculture Technical Group</h1>
					<p>The Agriculture Technical Group is dedicated to reducing the impacts of climate change by providing international leadership to mitigate global methane emissions through the abatement, recovery, and use of methane from agricultural sources. The technical group promotes collaboration between delegates from Partner Countries and Project Network members to build capacity, develop strategies and markets, and remove barriers to methane mitigation project development in order to increase environmental quality, improve rural livelihoods, strengthen the economy, and expand opportunities for renewable energy production and use.</p>
				</div>
                <div class="col-sm-4">
					<img src="../images/bkgd_sector_ag_banner2.jpg" style="width:100%;" />
					<p class="small">The primary sources of methane emissions from agriculture are livestock enteric fermentation, livestock waste management, rice cultivation, and agricultural waste burning. Of these, livestock waste management offers the most viable, near-term opportunities for methane recovery and utilization.</p>
				</div>
			</div>
					...
					<div class="row py-2">
                        <div class="col-sm-4">
							<h2>Co-chairs</h2>
                              ...
                              Canada</p>
                              <p><strong>Jorge Hilbert</strong><br>
                              National Institute of Agriculture Technology (INTA)<br>
                              Argentina</p>
						</div>
                        <div class="col-sm-4">
                              <h2>Members</h2>
                              <p>Representatives from 27 countries participate in the group.</p>
							  <p><a href="../delegates/index.aspx?sector=agriculture" role="button" class="btn btn-outline-primary">View Delegates</a></p>
                        ...
                        <div class="col-sm-4">
                              ...
                              <p><a href="index.aspx#tools" role="button" class="btn btn-outline-primary">Featured Biogas Resources</a></p>
                                            ...
                                            <p>Visit the GMI resource library to find tools, reports, presentations, and more related to mitigating methane emissions in the agriculture sector.</p>
                                          <p><a href="../resources/index.aspx?sector=Agriculture" role="button" class="btn btn-outline-primary">View Agriculture Resources</a></p>
						</div>
                    </div>
	...
	<section class="py-5">
		<div class="container">
			...
			<div class="row">
              <div class="col-sm-4">
				<p><strong>Are you interested in collaborating with GMI's Agriculture Technical Group on methane mitigation projects?</strong></p>
