<%@ Page Language="VB" AutoEventWireup="false" Inherits="M2M_Redesign.events_details" Codebehind="details.aspx.vb" %>
...
<body>
	...
	<section class="py-5 bg-white">
		<div class="container">
			<div class="row">
				<div class="col-sm-5">
                     <asp:PlaceHolder ID="phDraftAlert" runat="server"></asp:PlaceHolder>
        ...
        <section class="py-5 bg-white" runat="server" id="resourcerow">
            <div class="container">
                <div class="row">
