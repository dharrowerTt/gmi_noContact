<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="visaform.aspx.vb" Inherits="M2M_Redesign.visaform" %>
...
<body>
    <form id="form1" runat="server">
                            <asp:RadioButton id="noVisa" Text="I do not need a visa" GroupName="RadioGroup1" runat="server"/>
    ...
    <div>
                ...
                <fieldset id="visafields" style="display:none;">
                  ...
                  <div class="formgrid">
                       ...
                       <asp:TextBox type="text" name="fullname" id="fullName" value="" runat="server" placeholder="Full name, as it appears on your passport" required />
                        <label for="fullname">Full name</label>
  
                        <asp:TextBox type="text" name="passportnumber" id="PassportNumber" value=""  runat="server" required/>
                        <label for="passportnumber">Passport number</label>
  
                        <asp:TextBox type="text" name="placeissuance" id="Issuance" value="" runat="server" required/>
                        <label for="placeissuance">Place of issuance</label>
  
                        <asp:TextBox type="date" name="dateissuance" id="IssuanceDate" value="" runat="server" required/>
                        <label for="dateissuance">Date of issuance</label>
  
                        <asp:TextBox type="date" name="dateexpiration" id="ExpirationDate" value="" runat="server" required/>
                        <label for="dateexpiration">Date of expiration</label>
  
                        <asp:TextBox type="date" name="datebirth" id="BirthDate" value="" runat="server" required/>
                        <label for="datebirth">Date of birth</label>
  
                        <asp:dropdownlist name="citizenship" id="citizenship" required runat="server"> 
                        ...
                        <asp:TextBox type="text" name="embassy" id="embassy" value="" runat="server" placeholder="At which embassy/consulate will you be applying for your visa?" required />
                        <label for="embassy">Embassy</label>
  
                        <asp:TextBox type="text" name="schedule" id="schedule" value="" runat="server" placeholder="Planned schedule for visiting the United States (month, year and location)" required />
