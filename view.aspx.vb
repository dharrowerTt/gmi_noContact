...
Public Class view
    ...
    Private Function GetData() As DataTable
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("SELECT id as 'Manage', personFirstName as 'Name', personLastName, organization as 'Organization', countryName, email as 'Email Address', position as 'Position', countryCode, format(dateUpdated,'yy-MM-dd') as 'Last Updated' FROM _tableDelegateConfirm WHERE countryCode = '" & countryID & "'")
