...
M2Mpath10 = Request.ServerVariables("url")
M2Mpath11 = InStrRev(M2Mpath10,"/agriculture/")
M2Mpath12 = InStrRev(M2Mpath10,"/coal-mines/")
M2Mpath13 = InStrRev(M2Mpath10,"/landfills/")
M2Mpath14 = InStrRev(M2Mpath10,"/oil-gas/")
M2Mpath15 = InStrRev(M2Mpath10,"/steering/")
M2Mpath16 = InStrRev(M2Mpath10,"/wastewater/")
...
<ul id="sidenav">
	<li id="agnav"><a href="<%= Session("myPath") %>/agriculture/index.aspx" title="Agriculture"<%=NavState11%>>Agriculture</a></li>
    <li id="coalnav"><a href="<%= Session("myPath") %>/coal-mines/index.aspx" title="Coal Mines"<%=NavState12%>>Coal Mines</a></li>
    <li id="landnav"><a href="<%= Session("myPath") %>/landfills/index.aspx" title="Landfills"<%=NavState13%>>Landfills</a></li>
    <li id="oilnav"><a href="<%= Session("myPath") %>/oil-gas/index.aspx" title="Oil &amp; Gas"<%=NavState14%>>Oil &amp; Gas Systems</a></li>
    <li id="wwnav"><a href="<%= Session("myPath") %>/wastewater/index.aspx" title="Wastewater"<%=NavState16%>>Wastewater</a></li>
    <li id="steernav"><a href="<%= Session("myPath") %>/steering/index.aspx" title="Steering"<%=NavState15%>>Steering</a></li>
</ul>
<div id="translatebox">
	<h5>Translate this page</h5>
	<p>Global Methane Initiative provides fact sheets and links to resources in <a href="<%= Session("myPath") %>/chinese.aspx">Chinese</a>, <a href="<%= Session("myPath") %>/italian.aspx">Italian</a>, <a href="<%= Session("myPath") %>/russian.aspx">Russian</a>, and <a href="<%= Session("myPath") %>/spanish.aspx">Spanish</a>.</p>
	<form action="/">
        <fieldset>
