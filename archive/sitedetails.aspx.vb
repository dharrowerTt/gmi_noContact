    ...
    Private Function getSitebyId(ByVal myObjID As String) As Boolean
        ...
        Else
            ...
            For Each Site As DataRow In dt.Rows
                ...
                End If
                siteInfoHTML += "<th Class='text-right'>&nbsp;</th><td> <a href = '#details' role='button' Class='btn btn-primary'>View Site Details <i Class='fa fa-arrow-circle-down'></i></a></td></tr></tbody></table>"
