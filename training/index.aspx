<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="M2M_Redesign.index2" %>
...
<head runat="server">
    <title>Training | Global Methane Initiative</title>
...
<body>
	...
	<section class="py-5 gmi-light-blue">
        <div class="container">
					<h1>Training</h1>
					<p>The online training listed below is available to everyone. Click on the name of the course to view more details.</p>
		</div>
	</section>
	<section class="py-5 bg-white">
        <div class="container">
                ...
                <table id="MLtable" class="MLtable display responsive">
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            <td><a target="blank" href='coalminetraining.aspx'>Conducting Pre-Feasibility Studies for Coal Mine Methane Projects Training</a></td>
                            <td>Coal</td>
                            <td>2020-10-05</td>
                        </tr>
