<%@ Page Language="VB" AutoEventWireup="false" Inherits="M2M_Redesign.site_details" Codebehind="sitedetails.aspx.vb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Site Details | Methane Sites and Activities | Global Methane Initiative</title>
...
<body>
        ...
        <div class="container">
            ...
            <p><a href="index.aspx">
                ...
                <small class="text-muted text">
                    ...
                    <h1>
                        <asp:literal id="mysitename" runat="server"></asp:literal>
                    </h1>
	...
	<section class="py-2 border-top border-primary">
		<div class="container" id="details">
			<h2 class="text-center">Details: <asp:Literal ID="siteTitle" runat="server"></asp:Literal> </h2>
		</div>
	</section>
	<section class="py-5 bg-white">
		<div class="container">
			
					<asp:Literal ID="reductions" runat="server"></asp:Literal>

			
					<asp:Literal ID="ownership" runat="server"></asp:Literal>

			
            <asp:literal ID="physicalInfo" runat="server"></asp:literal>
					
			
			
					<asp:Literal id="gasCollectionInfo" runat="server"></asp:Literal>
			
			
            <asp:Literal id="wastecharacteristicsInfo" runat="server"></asp:Literal>
					
			
			
            <asp:Literal ID="additionalInfo" runat="server"></asp:Literal>
