...
<p>Click on the name of the activity to view more information and learn about other GMI activities that have been conducted at the same site. Use the keyword search and dropdown filters to find activities by name, sector, country/region, or type. </p>
			...
			<div class="border border-secondary bg-white px-0">
				<div class="py-1 text-center bg-dark text-white"><strong>Explore the Map of Methane Sites</strong></div>
                        	<p class="py-3 px-3">The activities listed below are presented visually on GMI's Map of Methane Sites. Use the map to see sites by geographic area.</p>
		                <p class="py-3 px-3"><a href="index.aspx" role="button" class="btn btn-outline-primary">Map of Methane Sites</a></p>
			</div>
                    </div>
