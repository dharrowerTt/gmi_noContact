<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="resources.vb" Inherits="M2M_Redesign.gmi_admin_resources" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div>
                ...
                <h1>List of Tools and Resources</h1>							
							<p>Click column name to sort. Click the resource name to edit the resource information. Click on the "Related Resource" name to view or edit details about that resource. Type a keyword in the box below to search for a specific record, or click the column header to sort.</p>
            							

                        <asp:Literal ID="LitResourceList" runat="server"></asp:Literal> 
...
<!-- new scripts for the copy/download -->
 ...
 <!-- script  type="text/javascript" src="/scripts/yadcf-master/jquery.dataTables.yadcf.js"></script -->
    ...
    $(document).ready(function () {
        $('#resourcelist').dataTable().yadcf([
		{ column_number: 1, column_data_type: "html", html_data_type: "text", filter_default_label: "Select year" },
	    // { column_number: 2, column_data_type: "html", html_data_type: "text", filter_default_label: "Select event" },
        { column_number: 3, column_data_type: "html", html_data_type: "text", filter_default_label: "Select event ID" },
	    { column_number: 4, column_data_type: "html", html_data_type: "text", filter_default_label: "Select language" },
	    { column_number: 5, column_data_type: "html", html_data_type: "text", filter_default_label: "Select" },
	    { column_number: 6, column_data_type: "html", html_data_type: "text", filter_default_label: "Select status" }]);
    });
</script>
