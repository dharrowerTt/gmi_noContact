<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="events.aspx.vb" Inherits="M2M_Redesign.gmi_admin_events" %>
...
<body onload="checkCookie()"> 
    ...
    <div class="row">
        ...
        <h1>List of Events</h1>							
                ...
                <asp:Literal ID="LitEventList" runat="server"></asp:Literal>
...
<!-- new scripts for the copy/download -->
 ...
 <!-- script  type="text/javascript" src="/scripts/yadcf-master/jquery.dataTables.yadcf.js"></script -->
    ...
    $(document).ready(function () {
	    ...
	    { column_number: 1, column_data_type: "html", html_data_type: "text", filter_default_label: "Select start month" },
        { column_number: 2, column_data_type: "html", html_data_type: "text", filter_default_label: "Select start year" },
	    { column_number: 3, column_data_type: "html", html_data_type: "text", filter_default_label: "Select sector" },
	    { column_number: 4, column_data_type: "html", html_data_type: "text", filter_default_label: "Select country" },
	    { column_number: 5, column_data_type: "html", html_data_type: "text", filter_default_label: "Select status"}]);
    });
</script>
            ...
            var table = $('#list').DataTable({
                ...
                "drawCallback": function (settings) {
                    ...
                    api.column(5, {
                        ...
                        if (last !== group) {
                            $(rows).eq(i).before(
                                '<tr class="group"><td colspan="8">' + group +
                                '</td></tr>'
                            );
