...
function initialize() {
    ...
    var center = new google.maps.LatLng(20.9101119, 15.6098586);
...
function selectAllFeatures() {
    if (document.frm.CK_SA.checked) {
        document.frm.CK_Ag.checked = true;
        document.frm.CK_Coal.checked = true;
        document.frm.CK_MSW.checked = true;
        document.frm.CK_Oil.checked = true;
        document.frm.CK_Wat.checked = true;
    }
    else
    {
        document.frm.CK_Ag.checked = false;
        document.frm.CK_Coal.checked = false;
        document.frm.CK_MSW.checked = false;
        document.frm.CK_Oil.checked = false;
        document.frm.CK_Wat.checked = false;
    }
    filterFeatures();
}
