<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="M2M_Redesign.index14" %>
...
<body>
    ...
    <!-- #include virtual="/includes/header.html" -->
        ...
        <section class="py-5 gmi-light-blue">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        <img id="titleImage" src="placeholder.png" style="width:100%" />
                    </div>
                    <div class="col-sm-9">
   ...
   <asp:Label ID="label2" runat="server" Text="" CssClass="warning" />
    ...
    <script>
        ...
        if (Resource == "Sweet_EN") {
            HeaderArea.textContent = "Download SWEET and sign up for GMI Updates";
            mainText.textContent = "Solid Waste Emissions Estimation Tool(SWEET) Version 4.0.6";
            HeaderImage.src = "https://globalmethane.org/assets/images/sweet_thumb.png";
            document.getElementById("resource").value = "Solid Waste Emissions Estimation Tool(SWEET) Version 4.0.6";
        }
        if (Resource == "Sweet_FR") {
            HeaderArea.textContent = "Download SWEET and sign up for GMI Updates";
            mainText.textContent = "l’Outil d’Estimation des Emissions de Déchets Solides (SWEET) v 4.0.5";
            HeaderImage.src = "https://globalmethane.org/assets/images/sweetFR_thumb.png";
            document.getElementById("resource").value = "SWEET_FR";
        }
        if (Resource == "Sweet_BP") {
            HeaderArea.textContent = "Download SWEET and sign up for GMI Updates";
            mainText.textContent = "Ferramenta para Estimativa de Emissões de Resíduos Sólidos (SWEET) v 4.0.5";
            HeaderImage.src = "https://globalmethane.org/assets/images/sweetBP_thumb.png";
            document.getElementById("resource").value = "SWEET_BP";
        }
        if (Resource == "Sweet_ES") {
            HeaderArea.textContent = "Download SWEET and sign up for GMI Updates";
            mainText.textContent = "Solid Waste Emissions Estimation Tool(SWEET) Version 4.0.4 [Spanish]";
            HeaderImage.src = "https://globalmethane.org/assets/images/sweet_thumb.png";
            document.getElementById("resource").value = "Solid Waste Emissions Estimation Tool(SWEET) Version 4.0.4 [Spanish]";
        }
        if (Resource == "Sweet_Serbian") {
            HeaderArea.textContent = "Download SWEET and sign up for GMI Updates";
            mainText.textContent = "Model za procenu emisija iz sektora upravljanja cvrstim otpadom (SWEET) v 4.0.5 (Serbian, Excel)";
            HeaderImage.src = "https://globalmethane.org/assets/images/sweet_thumb.png";
            document.getElementById("resource").value = "Model za procenu emisija iz sektora upravljanja cvrstim otpadom (SWEET) v 4.0.5 (Serbian, Excel)";
        }
        if (Resource == "LFG-ST") {
            HeaderArea.textContent = "Download LFG-ST and sign up for GMI Updates";
            mainText.textContent = "Landfill Gas Screening Tool (LFG-ST)";
            HeaderImage.src = "https://globalmethane.org/assets/images/LFG-ScreeningTool_2021.png";
            document.getElementById("resource").value = "Landfill Gas Screening Tool (LFG-ST)";
        }
        if (Resource == "LFG-ST_serbian") {
            HeaderArea.textContent = "Download LFG-ST and sign up for GMI Updates";
            mainText.textContent = "Model za pracenje deponijskih gasova (LFG-ST) (Serbian, Excel)";
            HeaderImage.src = "https://globalmethane.org/assets/images/LFG-ScreeningTool_2021.png";
            document.getElementById("resource").value = "Model za pracenje deponijskih gasova (LFG-ST) (Serbian, Excel)";
        }
        if (Resource == "OrganEcs") {
            HeaderArea.textContent = "Download OrganEcs and sign up for GMI Updates";
            mainText.textContent = "OrganEcs – Cost Estimating Tool for Anaerobic Digestion";
            HeaderImage.src = "https://globalmethane.org/assets/images/5984646546.png";
            document.getElementById("resource").value = "OrganEcs – Cost Estimating Tool for Anaerobic Digestion";
        }
        if (Resource == "CompostOrganEcs") {
            HeaderArea.textContent = "Download OrganEcs - Compost Version and sign up for GMI Updates";
            mainText.textContent = "OrganEcs – Compost Version";
            HeaderImage.src = "https://globalmethane.org/assets/images/organecs_thumb.png";
            document.getElementById("resource").value = "OrganEcs - Compost Version";
        }
        if (Resource == "ADOrganEcs") {
            HeaderArea.textContent = "Download OrganEcs - Anaerobic Digestion Version 3.1 and sign up for GMI Updates";
            mainText.textContent = "OrganEcs – Anaerobic Digestion";
            HeaderImage.src = "https://globalmethane.org/assets/images/5984646546.png";
            document.getElementById("resource").value = "OrganEcs - Anaerobic Digestion Version";
        }
        if (Resource == "ADST") {
            HeaderArea.textContent = "Download Anaerobic Digestion Screening Tool and sign up for GMI Updates";
            mainText.textContent = "Anaerobic Digestion Screening Tool";
            HeaderImage.src = "https://globalmethane.org/assets/images/AD-Tools_Cover-01-22.png";
            document.getElementById("resource").value = "Anaerobic Digestion Screening Tool";
        }
        if (Resource == "ADST_BP") {
            HeaderArea.textContent = "Download Anaerobic Digestion Screening Tool and sign up for GMI Updates";
            mainText.textContent = "Ferramenta ADST v2.4 Beta Version (Brazilian Portuguese, Excel)";
            HeaderImage.src = "https://globalmethane.org/assets/images/AD-Tools_Cover-BP.png";
            document.getElementById("resource").value = "Ferramenta ADST v2.4 Beta Version (Brazilian Portuguese, Excel)";
        }

        if (Resource == "WASTE") {
            HeaderArea.textContent = "Download Waste Characterization Handbook and sign up for GMI Updates";
            mainText.textContent = "Waste Characterization Handbook";
            HeaderImage.src = "https://www.globalmethane.org/assets/images/WasteCharacterizationHandbook.png";
            document.getElementById("resource").value = "Waste Characterization Handbook";
        }
        if (Resource == "WASTE_TOOL") {
            HeaderArea.textContent = "Download Waste Characterization Tool and sign up for GMI Updates";
            mainText.textContent = "Waste Characterization Tool";
            HeaderImage.src = "https://www.globalmethane.org/assets/images/WasteCharacterizationTool.png";
            document.getElementById("resource").value = "Waste Characterization Tool";
        }
