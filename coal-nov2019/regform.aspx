<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="regform.aspx.vb" Inherits="M2M_Redesign.regform10" EnableEventValidation="false" %>
...
<!------
    ...
    <h2>Registration</h2>
              ...
              <p>Online registration for the GMI Coal Subcommittee Meeting involves 2 steps.</p>

                <p><span>Step 1.</span> Please complete the form below to help us plan for the event, then click the Register button. You will receive confirmation by email that we have received your information. </p>

                <p><span>Step 2.</span>  After you complete the form below, you will be directed to the login screen for UNECE's UNCDB Online Meeting Registration system. You must register separately on UNECE's website using their event management system to complete your registration for the GMI Coal Subcommittee Meeting.</p>
                 ...
                 <asp:TextBox ID = "contactID" name="contactID" type="hidden" runat = "server" required/>
                  ...
                  <div class="formgrid">
                     ...
                     <asp:TextBox ID = "organization" name="organization" runat = "server" required/>
                       ...
                       <asp:dropdownlist name="delegateType" id="delegateType" required runat="server">
                            <asp:listitem value="">-- Select --</asp:listitem>
                            <asp:listitem value="Subcommittee">Subcommittee Member</asp:listitem>
                            <asp:listitem value="ProjectNetwork">Project Network Member</asp:listitem>
                      </asp:dropdownlist>
                        <label for="delegateType">Delegate Type</label>

                    <asp:dropdownlist name="presenting" id="presenting" required runat="server">
                            <asp:listitem value="">-- Select --</asp:listitem>
                            <asp:listitem value="Yes">Yes, I am interested</asp:listitem>
                            <asp:listitem value="No">No, I am not Interested</asp:listitem>
                      </asp:dropdownlist>
                        <label for="presenting">Are you interested in presenting your country or organization's updates?</label>
              ...
              <div class="centerbutton">
                              <asp:Button ID="Button1" runat="server" Text="Register" class="btn btn-coal" />
              </div>
            </form>
