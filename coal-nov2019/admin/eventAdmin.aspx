<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="eventAdmin.aspx.vb" Inherits="M2M_Redesign.eventAdmin10" %>
...
<script>
    ...
    function checkCookie() {
      ...
      if (user != "") {
        ...
        window.location.replace('index.html')/*opens the target page while Id & password matches*/
      }
    }
    </script>
</body>
