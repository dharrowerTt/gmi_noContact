<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="hotel.aspx.vb" Inherits="M2M_Redesign.hotel" %>
  ...
  <div id="page-container">
   <div id="content-wrap">
    <!--#include file="include/header.html"-->
      ...
      <!--#include file="content/hotel.html"-->
    ...
    <!--#include file="include/footer.html"-->
          ...
          <script>
        var element = document.getElementById("hotelLink");
