<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="info.aspx.vb" Inherits="globalmethane2020.info" %>
      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
              <asp:TextBox ID="bio" class="form-control" runat="server"></asp:TextBox>
          </div>
        </div>
