<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="logistics.aspx.vb" Inherits="M2M_Redesign.logistics110" %>
  ...
  <div id="page-container">
   <div id="content-wrap">
    <!--#include file="include/header.html"-->
      ...
      <!--#include file="content/logistics.html"-->
    ...
    <!--#include file="include/footer.html"-->
          ...
          <script>
        var element = document.getElementById("logisticsLink");
