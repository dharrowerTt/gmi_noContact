<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="edit-activity.aspx.vb" Inherits="M2M_Redesign.edit_activity" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Project Network Members App | Edit Activity Experience</title>
    ...
    <style>
        ...
        #btnSaveActivity, #btnDeleteActivity {
        ...
        #btnSaveActivity:hover, #btnDeleteActivity:hover {
        ...
        <section class="py-5 bg-white" style="background:#E9E6EE!important;">
            <div class="container">
                ...
                <div class="content-section">
                    <h3>Edit Activity Experience</h3>
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnSaveActivity" runat="server" Text="Save Activity Experience" OnClick="btnSaveActivity_Click" />
                        <asp:Button ID="btnDeleteActivity" runat="server" Text="Delete Activity Experience" OnClientClick="return confirm('Are you sure you want to delete this activity experience?');" OnClick="btnDeleteActivity_Click" />
                    </div>
                </div>
            </div>
        </section>
