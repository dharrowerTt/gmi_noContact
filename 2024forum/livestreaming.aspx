<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="livestreaming.aspx.vb" Inherits="M2M_Redesign.livestreaming" %>
...
<script>
  ...
  gtag('config', 'G-46JVDVGWQS');
    ...
    <style>
        ...
        .cardimage{
            width:auto;border-radius:10px;float:right; margin-left:12px;
        }
        @media screen and (max-width:1000px) {
            .cardimage{
                width:45%;border-radius:10px;float:right; margin-left:12px;
            }
        }
        @media screen and (max-width: 768px) {
            .cardimage{
                width:100%;border-radius:10px; margin-left:0;
            }
        }
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-gmi">
            <div class="container">
                <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                    <img src="img/trad logo white.svg" width="60"><span style="color:white;">Global Methane Initiative</a>
                </a>
...
<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="https://globalmethane.org/2022forum/" style="border-left:15px solid transparent;padding-left:30px;">2022 Global Methane, Climate and Clean Air Forum</a></li>
            <li><a class="dropdown-item" href="https://globalmethane.org/GMF2020/" style="border-left:15px solid 
transparent;padding-left:30px;">2020 Global Methane Forum (postponed)</a></li>
            <li><a class="dropdown-item" href="https://globalmethane.org/GMF2018/" style="border-left:15px solid transparent;padding-left:30px;">2018 Global Methane Forum</a></li>
            <li><a class="dropdown-item" href="https://globalmethane.org/forum/" style="border-left:15px solid transparent;padding-left:30px;">2016 Global Methane Forum</a></li>
          </ul>
        </li>
                </ul>-->
                <div class="d-flex">
...
<hr>
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        Links to the virtual sessions will be posted as they become available
                      </div>
