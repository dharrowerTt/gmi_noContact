<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registered.aspx.vb" Inherits="M2M_Redesign.registered" %>
...
<body>
    ...
    <script>
        ...
        if (searchParams.has('id')) {
            document.getElementById("resultText").innerHTML = "Looks like you already registered. Check your email for subject line 'Thanks for registering for the 2024 Global Methane Forum!'."
        } else {
            document.getElementById("resultText").innerHTML = "Thanks for registering."
        }
    </script>
